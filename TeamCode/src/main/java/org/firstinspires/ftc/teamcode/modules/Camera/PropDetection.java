...
public class PropDetection implements VisionProcessor {
    ...
    public static final int REGION_HEIGHT = SCREEN_HEIGHT - 100;
    
    public static final Point REGION1_TOPLEFT_ANCHOR = new Point(0, 60);
    public static final Point REGION2_TOPLEFT_ANCHOR = new Point(SCREEN_WIDTH / 3, 60);
    public static final Point REGION3_TOPLEFT_ANCHOR = new Point(SCREEN_WIDTH / 1.5, 60);
