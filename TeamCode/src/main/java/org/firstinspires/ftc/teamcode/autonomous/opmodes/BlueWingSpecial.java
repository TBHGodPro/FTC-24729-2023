...
@Autonomous(name = "Blue Wing Teammate Cycle", group = "Blue")
public class BlueWingSpecial extends BaseAutonOp {
    @Override
    ...
    public void runTrajectories() {
        ...
        switch (position) {
            case LEFT: {
                ...
                park = drive.trajectoryBuilder(yellow_pixel2.end(), true)
                        .back(6, SampleMecanumDrive.getVelocityConstraint(5, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH), SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                        .splineToConstantHeading(new Vector2d(45, 28), 0)
                        .build();
                break;
            }
